...
import { LogOut, User, Phone, Mail, ChevronRight } from 'lucide-react-native';
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View className="items-center bg-card px-4 py-8">
        ...
        <Text className="mt-1 capitalize text-muted-foreground">
          {user?.role === 'pencari' ? 'Pencari Kos' : user?.role}
        </Text>
      </View>
